...
public class Feedback extends Scheduler {
	...
	*/
	...
	public void reset(){
		...
		q.add(new Process(1, 10, 300, 1));
		q.add(new Process(2, 15, 320, 1));
		q.add(new Process(3, 210, 360, 1));
		q.add(new Process(4, 190, 290, 1));
		q.add(new Process(5, 50, 310, 1));
		q.add(new Process(6, 120, 325, 1));
		q.add(new Process(7, 220, 390, 1));
		q.add(new Process(8, 250, 195, 1));
		contextSwitches = 0;
	}
